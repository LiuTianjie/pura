const translations = {
  en: {
    ...
    "detail.docsTitle": "Screenshots into Feishu docs.",
    "detail.docsKicker": "Discussion",
    "detail.docsBody": "Paste or create one Docx document per device, then append saved screenshots with notes from the Hub UI.",
  ...
  zh: {
    ...
    "detail.docsTitle": "截图写入飞书文档。",
    "detail.docsKicker": "讨论文档",
    "detail.docsBody": "每台设备粘贴绑定或新建一个 Docx 文档，在 Hub 里把已保存截图和备注追加进去。",
