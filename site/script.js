const translations = {
  en: {
    ...
    "quick.step3": "Publish device",
    "arch.eyebrow": "Hub / Agent architecture",
    "arch.title": "Shared visibility without shared USB.",
    "arch.body":
      "The Hub owns discovery and session routing. Agents own physical devices, ADB, video capture, and local tap execution.",
    ...
    "deploy.body": "The Hub runs as a containerized control plane. Agents stay native beside the hardware.",
    ...
    "detail.controlBody": "The Hub receives browser clicks; the owning Agent translates them into ADB input on the phone.",
  ...
  zh: {
    ...
    "hero.lede": "pura 将研发手上的 USB 真机汇成局域网设备墙。ADB 留在本机，视频流与点击会话通过 Hub 路由。",
    "hero.primary": "快速开始",
    "hero.secondary": "架构模型",
    "showcase.title": "产品预览",
    ...
    "arch.body": "Hub 负责发现与会话路由；Agent 负责物理设备、ADB、视频采集与本地点击执行。",
    ...
    "deploy.body": "Hub 作为容器化控制面运行；Agent 原生运行在硬件旁边。",
    "deploy.tabCompose": "Compose",
    ...
    "detail.controlBody": "Hub 接收浏览器点击；拥有设备的 Agent 将其转换为手机上的 ADB 输入。",
